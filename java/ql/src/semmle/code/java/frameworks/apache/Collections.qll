  ...
  override predicate row(string row) {
    row =
      [
        ...
        "org.apache.commons.collections4.keyvalue;TiedMapEntry;true;TiedMapEntry;;;Argument[0];MapKey of Argument[-1];value",
        "org.apache.commons.collections4.keyvalue;TiedMapEntry;true;TiedMapEntry;;;Argument[1];MapValue of Argument[-1];value",
